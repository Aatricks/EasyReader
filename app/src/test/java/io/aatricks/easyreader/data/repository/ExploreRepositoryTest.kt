...
class ExploreRepositoryTest {
    ...
    private fun exploreItem(title: String, url: String) = io.aatricks.easyreader.data.model.ExploreItem(
        title = title,
        url = url,
        source = "TestSource",
    ...
    private class FakeNovelSource(
        ...
        override suspend fun searchNovels(query: String, page: Int): List<io.aatricks.easyreader.data.model.ExploreItem> = emptyList()
        override suspend fun getNovelDetails(url: String): io.aatricks.easyreader.data.model.ExploreItem =
            io.aatricks.easyreader.data.model.ExploreItem(title = url, url = url, source = name)
    }
}
