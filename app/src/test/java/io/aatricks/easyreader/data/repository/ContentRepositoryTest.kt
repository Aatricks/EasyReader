...
class ContentRepositoryTest {
    ...
    fun testMangaBatLastImageRemoval() {
        ...
        val imagesFromSelectors = mutableListOf(
            io.aatricks.easyreader.data.model.ContentElement.Image("page1.jpg"),
            io.aatricks.easyreader.data.model.ContentElement.Image("page2.jpg"),
            io.aatricks.easyreader.data.model.ContentElement.Image("page3.jpg"),
            io.aatricks.easyreader.data.model.ContentElement.Image("page4.jpg"),
            io.aatricks.easyreader.data.model.ContentElement.Image("page5.jpg"),
            io.aatricks.easyreader.data.model.ContentElement.Image("recommend_manga.jpg")
        )
